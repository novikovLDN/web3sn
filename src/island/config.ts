...
/** Подразбиение визуального рельефа. Ячейка = WORLD/SEG = 0.5 → очень детально. */
export const SEG = 240
/** Подразбиение физ. heightfield (чуть грубее меша ради производительности). */
export const PHYS_SEG = 160
/** Уровень моря. */

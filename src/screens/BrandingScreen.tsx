...
const PALETTES: Palette[] = [
  ...
  },
  {
    id: 'pine',
    name: 'Хвоя',
    note: 'Природный регистр. Зелёный работает как цвет плоскости и держит крупные заливки.',
    paper: '#edf3ee',
    ink: '#0f1a14',
    accent: '#1f7a4d',
    soft: '#a9cbb6',
    ...
    >
      ...
      >
        <SectionHead
          ...
          lead="Палитра — это не набор понравившихся оттенков, а распределение ролей с проверенным контрастом. Соотношения ниже посчитаны по WCAG прямо на странице: их можно перепроверить."
        />
      ...
      >
        <SectionHead
          ...
          lead="Носители собраны из тех же четырёх ролей цвета и той же пары гарнитур. Смена системы в панели внизу перекрашивает их одновременно — потому что решение принимается один раз, на уровне правила."
        />

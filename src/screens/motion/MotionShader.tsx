...
/**
 * Позиция камеры по Z в покое (scrollY === 0).
 * Причина именно 5.6 — вместимость кадра, а НЕ освобождение левой половины под
 * заголовок: меш стоит в начале координат, камера на оси, форма выходит ровно
 * по центру и заголовок ложится на неё. При fov 45 z = 4.2 даёт полувысоту
 * 1.74 против ~1.92 радиуса смещённой формы — силуэт срезался сверху и снизу;
 * z = 5.6 даёт 2.32 и вмещает форму целиком. За контраст заголовка поверх
 * формы отвечает скрим в MotionHero.tsx, а не кадрирование.
 */

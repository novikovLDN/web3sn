...
export const MOTION_VARS: CSSProperties = {
  '--m-abyss': C.abyss,
  '--m-panel': C.panel,
  /* Приподнятая поверхность — выбранная карточка, дно инструмента.
     Нужна отдельной ступенью: без неё «активное» состояние приходится
     показывать цветом рамки, и панель инструментов теряет глубину. */
  '--m-panel-2': '#132B2F',
  '--m-border': C.border,
  '--m-petrol': C.petrol,
  '--m-sea': C.seaGlass,
  /* Полупрозрачные производные морского стекла: дорожки, сетки, риски.
     Держим переменными, потому что в разметке они встречаются чаще
     самого акцента, а хекс с альфой в JSX запрещён правилами экрана. */
  '--m-sea-16': 'rgba(127,178,174,0.16)',
  '--m-sea-35': 'rgba(127,178,174,0.35)',
  '--m-chalk': C.chalk,
  '--m-dim': C.dim,
  '--m-ember': C.ember,
  /* Предупреждение — тот же ember, приглушённый до фона.
     Отдельного «красного» на экране нет: два акцента спорили бы. */
  '--m-warn-12': 'rgba(226,114,91,0.12)',
} as CSSProperties

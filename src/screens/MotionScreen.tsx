...
const DELIVERABLES = [
  {
    t: 'Мастер-файлы',
    d: 'Проект сборки со слоями и именованными композициями — не только просчитанное видео.',
  },
  {
    t: 'Экспорты под площадки',
    d: 'Форматы, кодеки и хронометражи под каждую площадку — с вертикалью и версией без звука.',
  },
  {
    t: 'Спецификация движения',
    d: 'Таблица переходов: слой, окно на таймлайне, кривая, свойства — разработчик собирает переход, не угадывая.',
  },
  {
    t: 'Кривые и длительности',
    d: 'Именованный набор кривых и ступени шкалы — значениями, которые кладутся прямо в код, как на этом сайте.',
  },
  {
    t: 'Веб-сборка вместо видео',
    d: 'Где движение живёт в интерфейсе — лёгкая сборка с проверенным поведением на слабых машинах, а не мегабайты ролика.',
  },
  {
    t: 'Правила движения',
    d: 'Что анимируется, что — никогда, что происходит при prefers-reduced-motion. Без этого раздела продукт и начинает дёргаться.',
  },
]

const STEPS = [
  { t: 'Разбор', d: 'Что должно стать понятно зрителю и за какое время. Формат выбирается после ответа на этот вопрос.' },
  ...
  { t: 'Сборка', d: 'Финальная графика, движение, звук. Спецификация пишется по ходу сборки.' },
]
        ...
        <div className="lg:col-span-4 lg:col-start-9">
          <Reveal y={16} delay={0.4}>
            ...
            >
              ...
              >
                Переключает кривую, по которой на экран выходит <em>текст</em> —
                и вместе с ним появления секций, наведения, кнопки, прогоны
                инструментов. Ваш выбор кривой — это и есть выбор анимации,
                с которой текст появляется на экране.
              </p>
        ...
        >
          ...
          <Reveal y={12} delay={0.06}>
            ...
            >
              ...
              либо идёт по правилам, либо каждый следующий подрядчик придумывает
              своё — и решается это сейчас, один раз.
            </p>
          </Reveal>

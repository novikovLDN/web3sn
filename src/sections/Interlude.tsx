  ...
  return (
    <section
      ...
      style={{
        ...
        //
        // Ровно 100svh, а не 78. Пауза, в которой снизу видна следующая
        // секция, паузой быть перестаёт: глаз уже читает то, что дальше,
        // и тишины не происходит. Полная остановка требует всего экрана —
        // готовность отдать его целиком и есть само высказывание.
        minHeight: '100svh',

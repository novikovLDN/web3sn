...
const SERVICES: Service[] = [
  {
    ...
    name: '3D-моделинг',
    description:
      'Объекты, персонажи и окружения, готовые к рендеру и к движку — с топологией, развёрткой и текстурами, которые не придётся переделывать.',
  ...
  },
  {
    ...
    name: 'Разработка',
    description:
      'Сайт или веб-приложение до продакшена: вёрстка, логика, движение, 3D. В браузере — так же, как в макете.',
  ...
  },
  {
    ...
    name: 'Брендинг',
    description:
      'Бренд-система целиком — знак, типографика, палитра, носители — с гайдлайном, по которому её ведёт ваша команда без меня.',
  ...
  },
  {
    ...
    name: 'Веб-дизайн',
    description:
      'Макеты, из которых продукт собирается без домысливания: сетка, типографика, состояния, поведение на всех экранах.',
